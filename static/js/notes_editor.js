...
const NotesEditor = (() => {
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (_currentNoteId && currentTitle === _originalTitle) {
        ...
        Swal.fire({ title: "Saved!", text: "Note has been updated.", icon: "success", timer: 1500, showConfirmButton: false });
      } else {
        ...
        // SweetAlert2 success feedback
        Swal.fire({ title: "Created!", text: "New note has been saved.", icon: "success", timer: 1500, showConfirmButton: false });
      }
  ...
  async function showConfirm(noteId) {
  ...
  async function handleConfirmDelete() {
    ...
    try {
      ...
      // SweetAlert2 success feedback
      Swal.fire({ title: "Deleted!", text: "Note has been deleted.", icon: "success", timer: 1500, showConfirmButton: false });
      await refresh();
    } catch (err) {
      showStatus(`❌ ${err}`, "error");
      // SweetAlert2 error feedback
      Swal.fire({ title: "Delete Failed", text: String(err), icon: "error" });
    } finally {
      hideConfirm();
    }
  }
